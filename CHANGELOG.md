...
*   **The tab strip announced "Search" before every tab name.** It had no name of its own, and a screen reader will not leave a control unnamed — it goes looking and reads whatever it finds nearby. It is now named.
