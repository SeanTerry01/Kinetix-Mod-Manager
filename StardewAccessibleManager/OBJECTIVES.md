...
*   **Description**: Manage Mods Path, Nexus API Key, Splash Screen, and Sound Volume (Hotkey: Ctrl+P).
*   **Status**: Completed.

### 6. Automated Backup Management
*   **Description**: Automatically prune old backups to save disk space (Hotkey: Ctrl+B).
*   **Status**: Completed.
