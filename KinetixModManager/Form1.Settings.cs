...
public partial class Form1
{
	...
	private void ShowSettings()
	{
		...
		// Left unnamed for the same reason as the main window's strip: a blank name did not silence it, it made
		// the reader announce the role — "tab control" — before every tab instead. See the note there.
